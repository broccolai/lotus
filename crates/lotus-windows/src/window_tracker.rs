...
impl WindowTracker {
    ...
    pub fn handle_message(
        ...
        let snapshot = self
            ...
            .clone();
        let windows_changed = self.window_revision != snapshot.window_revision;
        let fullscreen_changed = self.fullscreen_revision != snapshot.fullscreen_revision;
        ...
        Ok(windows_changed
            ...
            .or_else(|| {
                fullscreen_changed.then_some(WindowTrackerEvent::FullscreenRefreshed)
            }))
    }
