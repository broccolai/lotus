...
use super::{LauncherResultKind, LauncherScene};
...
impl<Asset> LauncherScene<Asset> {
    ...
    pub fn layout(&self) -> LauncherLayout {
        ...
        LauncherLayout {
            ...
            empty_state: self.empty_state(size, results_top, footer.separator.top),
            footer_separator: footer.separator,
            footer_label: footer.label,
            footer_time: footer.time,
            scrollbar_thumb: self.scrollbar_thumb(size, results_top, footer.separator.top),
